...
from .models import Customer,Restaurant,Orders,orderProducts,Status,Product,deliveryPersonnel,Address,CustAddress,CustNos,restPhNos,Review,Authenticate,Delivery,payInfo,Payment,Manager,Category,Product_categ,ManNos,availability
